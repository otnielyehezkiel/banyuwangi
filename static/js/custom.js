...
$(document).ready(function(){
  ...
  //setTimeout(function() {noty({text: '<strong>Hai! Selamat pagi dan Selamat Bekerja.</strong>',layout:'topRight',type:'information',timeout:15000});}, 7000);

  //setTimeout(function() {noty({text: 'Harap selalu cek Pekerajaan Ada.',layout:'topRight',type:'alert',timeout:13000});}, 9000);
